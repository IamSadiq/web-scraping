...
class InstagramBot:
    def __init__(self, email, password):
        ...
        self.browser = webdriver.Chrome('./drivers/chromedriver.exe', chrome_options=self.browserProfile)
        self.email = email
    ...
    def followWithUsername(self, username):
        ...
        if followButton.text != 'Following':
            ...
            print("You're already following this users")
